...
Arduino library for Walrus pressure sensors (water level/depth).
...
This is a **sensor library**. Schema 1 migration is required once the spec is stable and a Schema 0 snapshot tag exists. Refer to the Walrus device appendix in [NW-Device-Specification](https://github.com/NorthernWidget/NW-Device-Specification) for the exact Page 1 register layout.
